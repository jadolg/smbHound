...
public final class IpTools {
    ...
    public IpTools(DefaultListModel lm) {
        this.lm = lm;
    }
...
//    private ArrayList<String> getIps2(){
//        ArrayList<String> result = new ArrayList<String>();
//        result.add("10.8.126.0");
//        return result;
//    }

    public static String getAddrPrefix(String address) throws Exception {
        if (address.equals("0.0.0.0") || address.equals("127.0.0.1")) {
            throw new Exception("Not connected");
        } else {
            String res = (address.substring(0, address.lastIndexOf(".")));
            return res;
        }
    }

    public static ArrayList<String> prefixes() throws Exception {
        ArrayList<String> result = new ArrayList<String>();
        for (String i : getIps()) {
